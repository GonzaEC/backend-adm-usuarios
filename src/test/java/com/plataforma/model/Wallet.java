...
public class Wallet extends Auditable
{
     ...
     * La lógica vive acá y no en el service, porque es una propiedad
     * intrínseca del Wallet saber si puede cubrir un monto.
     */
     ...
     * Precondición: hasSufficientFunds debe haber sido validado antes.
     * Este método no valida — solo ejecuta. La validación es responsabilidad
     * del llamador (WalletService).
     */
